    ...
    <section id="impact" className="py-20 bg-background relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <Card className="hover:shadow-lg transition-shadow">
            <CardContent className="p-8">
              <div className="w-12 h-12 bg-secondary text-secondary-foreground rounded-lg flex items-center justify-center mb-6">
          ...
          <Card className="hover:shadow-lg transition-shadow">
            <CardContent className="p-8">
              <div className="w-12 h-12 bg-accent text-accent-foreground rounded-lg flex items-center justify-center mb-6">
