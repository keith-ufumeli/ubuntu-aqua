          ...
          <div className="bento-item bento-hero">
            <Card className="card-hero">
              <CardContent className="bento-content">
                ...
                <a href="#" className="bento-cta">Learn more</a>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="bento-item bento-feature">
            <Card className="card-feature">
              <CardContent className="bento-content">
                ...
                <a href="#" className="bento-cta">Explore tools</a>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="bento-item bento-accent">
            <Card className="card-accent">
              <CardContent className="bento-content">
                ...
                <a href="#" className="bento-cta">Get started</a>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="bento-item bento-wide">
            <Card className="card-minimal">
              <CardContent className="bento-content">
                ...
                <a href="#" className="bento-cta">View impact</a>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="bento-item bento-medium">
            <Card className="card-minimal">
              <CardContent className="bento-content">
                ...
                <a href="#" className="bento-cta">Discover tech</a>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="bento-item bento-tall">
            <Card className="card-dark">
              <CardContent className="bento-content">
                ...
                <a href="#" className="bento-cta">View full report</a>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="bento-item bento-bottom">
            <Card className="card-minimal">
              <CardContent className="bento-content">
                ...
                <a href="#" className="bento-cta">Get started now</a>
              </CardContent>
            </Card>
          </div>
        </div>
