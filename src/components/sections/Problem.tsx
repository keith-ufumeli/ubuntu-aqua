          ...
          <div className="max-w-[571px] space-y-16">
            ...
            <div>
              <h2 className="font-heading text-3xl sm:text-4xl lg:text-[2.25rem] font-medium text-foreground leading-tight mb-6">
                <span className="text-[#744127]">The Water Safety Challenge in </span>
                  ...
                  <div className="w-12 h-12 relative">
                    <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g>
                        ...
                        <path d="M10.9686 2.08498C4.70483 4.22908 1.57298 5.30113 0.7865 6.42169C0 7.54225 0 10.8731 0 17.5348C0 17.5348 0 18.75 0 18.75L18.75 12.5C18.75 12.5 18.75 0 18.75 0C17.0596 0 15.4271 0.558833 12.1619 1.6765C12.1619 1.6765 10.9686 2.08498 10.9686 2.08498Z" fill="#F49E0B" fillOpacity="0.5" transform="translate(6.25 4.167)" />
